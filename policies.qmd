...
### Late Work Policy and Excused Absences
...
I would highly encourage you to attend office hours and you can attend any office hour(s) of your choice. 
...
We want to be mindful of you who commute to campus so if you'd choose to attend office hours virtually, we will also be available online via zoom. The hours and locations can be checked under [People](people.qmd). You will need to use your [UCI zoom account](https://uci.zoom.us/) to attend the zoom meeting.
...
**Please do not email me about course content** unless it is private to you. 
If you are running into an issue, **it is very likely that someone else is also having the same issue**. 
Please post on the discussion forum so that we can all learn together. 
You can post anonymously on the discussion forum which would hide your name from peers.
This way I would only answer the question once and everyone can benefit. 
In fact, your TA or one of your peers may even answer it before I do. 
You can get a much quicker response.
...
### Getting Help from Other People and Generative AI Tools{#sec-ai}

For any assignment other than the midterm, you can receive help from your peers and generative AI tools. 
The midterm is in-person and closed book.
I would recommend you to use [ZotGPT Class Chat](https://zotgpt.uci.edu/classchat/) if you would like to get help from generative AI. 
Remember that even though Class Chat is utilized for our own class, generative AI responses can be incorrect. 
Use at your own risk.
General rules about getting help from peers and AI-like tools include the following.

- Use tools and discuss with people to LEARN. Do not use tools or discuss with people to simply copy and submit the assignment.
...
Everything on the syllabus is subject to change depending on any unexpected circumstances that might arise during the quarter. 
